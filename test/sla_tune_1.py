...
def autotune_best_config(q, k, v, topk_ratio=0.1, reps=5, warmup_reps=3):
    """
    candidates = [
        # format: (BLKQ, BLKK, num_warps, num_stages)
        ( 64,  64,  4, 3),
        ( 64,  64,  8, 4),
        (128,  64,  8, 3),
        (128,  64, 16, 4),
        ...
        (256, 128,  8, 3),
        (256, 128, 16, 4),
        # (256, 256, 16, 3),   # only if memory allows
    ]
    """
    """
    candidates = [
        # Previous good ones (keep them)
        ( 64,  64,  4, 3),
        ( 64,  64,  8, 4),
        (128,  64,  8, 3),
        (128, 128,  8, 3),
        (256, 128, 16, 4),          # current winner
        ...
        #(384, 192, 16, 4),
        (512, 128, 16, 5),
        (512, 128, 32, 5),          # more warps on very large query tiles
        (256,  64, 16, 4),          # smaller key tiles
        #(256,  96, 16, 4),

        # ─── Experimental / sometimes win on Arc / XMX ──────────────────
        #(192, 128, 12, 4),
        #(384,  64, 16, 6),
        (512,  64, 32, 6),
        #(512, 128, 24, 5),
