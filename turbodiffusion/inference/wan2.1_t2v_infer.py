...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        text_emb = get_umt5_embedding(checkpoint_path=args.text_encoder_path, prompts=args.prompt, device="cpu").to(**tensor_kwargs)
    clear_umt5_memory()
    ...
    # Sampling steps
    x = init_noise.to(torch.bfloat16) * t_steps[0]
